...
class StreamVideoProcessor {
    ...
    async detectFFmpeg() {
        ...
        // Tentar ffmpeg-static como fallback
        try {
            let ffmpegStatic;
            
            // Tentar diferentes formas de carregar ffmpeg-static
            try {
                ffmpegStatic = require('ffmpeg-static');
            } catch (reqError) {
                // Tentar caminho absoluto baseado no diretório atual
                const path = require('path');
                const ffmpegStaticPath = path.join(process.cwd(), 'node_modules', 'ffmpeg-static');
                ffmpegStatic = require(ffmpegStaticPath);
            }
            ...
            // Testar se o binário do ffmpeg-static funciona
            ...
            console.log('❌ Erro ao carregar ffmpeg-static:', error.message);
        }

...
const { optimizedAxios, fetchBuffer: optimizedFetchBuffer, uploadFile } = require('./HttpConfig')
const axios = optimizedAxios
...
exports.fetchBuffer = async (url, options) => {
	try {
		return await optimizedFetchBuffer(url, options)
	} catch (err) {
		console.error('[Function.js] fetchBuffer erro:', err.message)
		return err
	}
}
